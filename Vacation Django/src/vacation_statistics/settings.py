"""
Django settings for vacation_statistics project.
...
# from encrypted_cookie_session.backends import EncryptedCookieStorage
...
SECRET_KEY = 'django-insecure-4ig43of$r0$@32g9mzzbia@lnu!_pc6p15&us&x38_@09s3@xs'
...
INSTALLED_APPS = [
    ...
    # My installed apps
    'api.apps.ApiConfig',
    'all_vacations.apps.AllVacationsConfig',
...
ROOT_URLCONF = 'vacation_statistics.urls'
...
WSGI_APPLICATION = 'vacation_statistics.wsgi.application'
